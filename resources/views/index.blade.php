...
@section('content')
    ...
    <h2>Yritykseni</h2>
    <p>Taho Ohjelmistopalvelut Oy on 2018 perustamani ohjelmistokonsultointiyritys. Myyn yksittäistä suunnittelu- ja
        kehitysosaamista
    ...
    <p>Jokainen intohimoinen koodari harrastaa omia projektejaan. Niin myös minäkin. Esimerkkinä <a target="_blank"
                                                                                                    href="https://www.superlender.fi/">SuperLender</a>-vertaislainasovellus,
        jonka
        toteutin täysin itsenäisesti. Ja mikä parasta, sain valita uusimmat mahdolliset teknologiat, <em>Angular 5</em> ja <em>Clojure</em>.
    </p>
    ...
    <p>Ota yhteyttä, niin sovitaan toimeksianto!</p>
